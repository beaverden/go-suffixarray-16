...
func main() {
	...
	for {
		...
		if strings.HasSuffix(name, "_32") {
			...
			buf.WriteString(fix32_16.Replace(fn))
		}

		if strings.HasSuffix(name, "_8_32") {
			// x_8_32 -> x_8_64 done above
			fn32 := fix8_32.Replace(stripByteOnly(fn))
			buf.WriteString(fn32)
			buf.WriteString(fix32.Replace(fn32))
			buf.WriteString(fix32_16.Replace(fn32))
		}
	}
...
var fix32_16 = strings.NewReplacer(
	"32", "16",
	"int32", "int16",
)
...
var fix8_32_16 = strings.NewReplacer(
	"_8_32", "_16",
	"byte", "int16",
)
