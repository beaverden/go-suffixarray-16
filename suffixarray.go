...
var maxData16 int = realMaxData16
const realMaxData32 = math.MaxInt32
const realMaxData16 = math.MaxInt16
...
func (a *ints) len() int {
	return len(a.int16) + len(a.int32) + len(a.int64)
}
...
func (a *ints) slice(i, j int) ints {
	if a.int16 != nil {
		return ints{a.int16[i:j], nil, nil}
	} else if a.int32 != nil {
		return ints{nil,a.int32[i:j], nil}
	}
	return ints{nil,nil, a.int64[i:j]}
}
...
func New(data []byte) *Index {
	ix := &Index{data: data}
	if len(data) <= maxData16 {
		ix.sa.int16 = make([]int16, len(data))
		text_16(data, ix.sa.int16)
	} else if len(data) <= maxData32 {
...
func (x *Index) Read(r io.Reader) error {
	...
	if 2*n < cap(x.data) || cap(x.data) < n ||
		x.sa.int16 != nil && n > maxData16 ||
		x.sa.int32 != nil && n > maxData32 ||
		x.sa.int64 != nil && n <= maxData32 {
...
func (x *Index) Lookup(s []byte, n int) (result []int) {
	if len(s) > 0 && n != 0 {
		...
		if n > 0 {
			result = make([]int, n)
			if matches.int16 != nil {
				for i := range result {
					result[i] = int(matches.int16[i])
				}
			} else if matches.int32 != nil {
				for i := range result {
